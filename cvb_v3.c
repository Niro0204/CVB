...
void printLines(FILE*,int,int,formating,bool);
int totalLines(FILE*);
...
int main(int argc, char* argv[]){
    ...
    if (!quiet_mode) {
        ...
        printLines(file, startLine, endLine, format, verbose_mode);
...
void printLines(FILE* file, int startLine, int endLine, formating options, bool verbose_mode) {
